...
struct android_app {
    ...
    // 상태가 없는 경우 NULL이 되며, 필요하면 사용할 수 있습니다.
    ...
    // 창의 현재 콘텐츠 사각형입니다. 이곳은 사용자에게 표시되는
    // 창 콘텐츠를 배치해야 하는 영역입니다.
    ARect contentRect;

    // 앱 활동의 현재 상태입니다. APP_CMD_START일 수 있습니다.
